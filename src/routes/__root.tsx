...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BidArena — Cinematic Cricket Auction Platform" },
      ...
      { property: "og:title", content: "BidArena — Cinematic Cricket Auction Platform" },
      ...
      { name: "twitter:title", content: "BidArena — Cinematic Cricket Auction Platform" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@500;700&family=Inter:wght@400;500;600;700&family=Bricolage+Grotesque:opsz,wght@12..96,200..800&family=Syne:wght@400..800&display=swap" },
    ],
  }),
