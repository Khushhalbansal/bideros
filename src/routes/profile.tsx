...
function ProfilePage() {
  ...
  const [favSportStr, setFavSportStr] = useState(
    () =>
  ...
  const getStat1Label = () => {
    if (sport.slug === "cricket")
      return { label: "Batting", placeholder: "e.g. 1240 runs, avg 38.2" };
  ...
  const getStat2Label = () => {
    if (sport.slug === "cricket")
      return { label: "Bowling", placeholder: "e.g. 42 wickets, econ 6.1" };
    ...
    >
      ...
      <main className="container mx-auto px-4 pb-16 max-w-3xl relative z-10">
        <div className="bg-black/40 backdrop-blur border border-white/10 rounded-2xl p-6 md:p-8 space-y-6 shadow-2xl">
          ...
          <div>
            <Label className="text-white/80 text-xs uppercase tracking-wider mb-3 block">
              Favorite Sport
            </Label>
            ...
            <p className="text-[10px] text-white/40 mt-2">
              This customizes the theme of your dashboard and sign-in page.
            </p>
          </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  className="bg-white/5 border-white/20 text-white"
                  value={form.stat1}
                  onChange={(e) => setForm({ ...form, stat1: e.target.value })}
              ...
              <div>
                ...
                <Input
                  className="bg-white/5 border-white/20 text-white"
                  value={form.stat2}
                  onChange={(e) => setForm({ ...form, stat2: e.target.value })}
