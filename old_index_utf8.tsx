    ...
    <div className="min-h-screen">
      ...
      <ParallaxHero>
        <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 flex flex-col items-center justify-center text-center px-4 overflow-hidden">
          ...
          <div className="funky-sticker" style={{ top: '10%', left: '15%', animationDelay: '0s' }}>≡ƒöÑ</div>
          <div className="funky-sticker" style={{ top: '35%', right: '10%', animationDelay: '1s' }}>≡ƒæ╜</div>
          <div className="funky-sticker" style={{ bottom: '25%', left: '25%', animationDelay: '0.5s' }}>≡ƒÆ╕</div>
          <div className="funky-sticker" style={{ bottom: '15%', right: '25%', animationDelay: '1.5s' }}>Γ£¿</div>
          ...
          >
            {isFunky 
              ? "Main character energy only. Real-time team rooms. A stadium-grade spectator view ΓÇö no login required to vibe."
              : "IPL-style live bidding. Real-time team rooms. A stadium-grade spectator view ΓÇö no login required to watch."}
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <section id="browse" className="mt-10 max-w-6xl mx-auto scroll-mt-24">
          <Reveal>
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
              ...
              <div className="relative w-full md:w-80">
                ...
                <Input value={q} onChange={e => setQ(e.target.value)} placeholder="Search tournamentsΓÇª" className="pl-9 focus:border-neon focus:shadow-neon transition-all" />
              </div>
            </div>
          </Reveal>
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] p-8 mb-8 border border-hot/30 shadow-[0_0_40px_-10px_rgba(255,50,50,0.15)]">
            ...
            <div className="relative z-10">
              <TournamentGroup title="≡ƒö┤ Ongoing" items={ongoing} emptyText="No auctions live right now." accent="hot" />
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] p-8 mb-8 border border-neon/30 shadow-[0_0_40px_-10px_rgba(50,255,150,0.1)]">
            ...
            />
            <div className="relative z-10">
              <TournamentGroup title="≡ƒùô Upcoming" items={upcoming} emptyText="No upcoming tournaments." accent="neon" />
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] p-8 border border-muted/30">
            ...
            />
            <div className="relative z-10">
              <TournamentGroup title="≡ƒÅå Past" items={past} emptyText="No completed tournaments yet." accent="muted" />
            </div>
          </div>
        </section>
          ...
          <section className="mt-32 max-w-4xl mx-auto text-center border border-neon/30 rounded-[3rem] p-16 shadow-[0_0_60px_-15px_rgba(50,255,150,0.3)] relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <Button asChild size="lg" className="gradient-neon text-primary-foreground shadow-neon font-semibold hover:scale-105 transition-transform">
                <Link to="/auth">Get started ΓÇö it's free <ArrowRight className="ml-1" /></Link>
              </Button>
            </div>
          </section>
        </Reveal>
      ...
      <footer className="container mx-auto px-4 py-12 text-center text-xs text-muted-foreground border-t border-border space-y-6">
        ...
        <div>
          Bideros ΓÇö built for the love of the game.
        </div>
      </footer>
    </div>
  );
            ...
            >
              <Link to="/watch/$slug" params={{ slug: t.id }} className={`bg-glass border border-border rounded-xl overflow-hidden transition-all ${border} block group`}>
                ...
                <div className="p-4">
                  ...
                  <div className="text-xs text-muted-foreground mb-3">Purse {formatINR(t.purse_per_team)} ΓÇó Squad {t.max_players_per_team}</div>
